self.onmessage = e => {
  ...
  for (let i = 0; i < decks.length; i++) {
    ...
    let copy = e.data.screenSize < 1024 ? `onclick="copyDeckSaved(https://link.clashroyale.com/deck/pt?deck=${contentToCopy})" data-clipboard-text="https://link.clashroyale.com/deck/pt?deck=${contentToCopy}"` : `data-clipboard-text="https://link.clashroyale.com/deck/pt?deck=${contentToCopy}"`;
    html += `
