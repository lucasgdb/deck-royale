  ...
  for (let i = 0; i < decks.length; i++) {
    ...
    html += `
      ...
      <section class="configContainerS">
        <button class="btnCopiarS" title="Copy deck" ${e.data.screenSize < 1024 ? `onclick="copyDeckSaved('deck=${contentToCopy}')" oncontextmenu="copyDeckPhone('${contentToCopy}')"` : `data-clipboard-text="https://link.clashroyale.com/deck/pt?deck=${contentToCopy}" oncontextmenu="copyDeckSaved('${contentToCopy}')"`}>Copy deck</button>
