  ...
  for (let i = 0; i < decks.length; i++) {
    ...
    html += `
      ...
      <section class="configContainerS">
        <button class="btnCopiarS" title="Copiar Deck" ${e.data.screenSize < 1024 ? `onclick="copyDeckSaved('${contentToCopy}')"` : `data-clipboard-text="https://link.clashroyale.com/deck/pt?deck=${contentToCopy}"`}>Copiar Deck</button>
